...
Now you need to give the virtual machine access to your data. The following uses a share called `\\myserver.whatever.edu\ifcbdata` as an example. You should use your real data server's name and share name.
